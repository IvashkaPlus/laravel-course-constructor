...
<div class="modal bd-example-modal-lg fade" id="updateLecture" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                <button type="button" class="btn btn-primary update-lesson-item-lecture">Сохранить</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form id="videoCreateForm">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="url" id="videoTitleInput" placeholder="Пример: https://youtu.be/0eOu0R24F-c">
                    </div>
                    <div class="form-group">
